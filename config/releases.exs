...
config :ex_esi,
  user_agent:
    "Phylax/0.4.2 (PROD #{to_string(node())}) Erlang/OTP #{:erlang.system_info(:otp_release)} [erts-#{
...
#
# Not setting this up yet for 0.4.2 since the webinterface is not implemented yet.
#
